...
class Settings_common(QtWidgets.QToolBox):
    ...
    def createWidgets(self):
        ...
        self.line_By_Frame=QtWidgets.QLineEdit('1.000')
        ...
        self.combox_Preset.addItems\
            (['Custom',u'640×480','1k_Square','2k_Square','HD_540','HD_720','HD_1080'])
    ...
    def get_Information(self):
        ...
        self.start_frame=int(self.line_Start_Frame.text()) #获得起始帧数
        self.end_frame=int(self.line_End_Frame.text())     #获得结束帧数
...
class Settings_render(QtWidgets.QDialog):
    def __init__(self,parent=None):
        ...
        self.progress_Rendering=QtWidgets.QProgressBar()                    #渲染进度条 progress
